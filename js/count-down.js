...
function getdate() {
    ...
    var tomorrowString = (tomorrowDate.getMonth() + 1) + "/" + tomorrowDate.getDate() + "/" + tomorrowDate.getFullYear() + " 00:00:00";
...
var ColorCode = function () {
    var fullitem = parseInt($("span.hours").text(), 10);
    if (fullitem <= 1) {
        console.log("Less than 12");
        $("span.hours").addClass('red');
        $("span.minutes").addClass('red');
        $("span.seconds").addClass('red');
    }
};

CountdownRun().done(ColorCode);